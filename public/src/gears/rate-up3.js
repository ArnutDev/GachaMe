...
async function rateUp3() { //change this to n
    //change this to n
    const divSlots = document.querySelectorAll('.content-display3'); // เลือก div ทั้ง 7 อัน
...
function handleModalReopen() {
    ...
    const myModalElement = document.getElementById('myModal3'); //change this to n
