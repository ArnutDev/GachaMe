    ...
    setTimeout(async () => {
        ...
        for (let i = 0; i < 6; i++) {
            ...
            if (chance <= 1) {
                ...
                if (result) {
                    //j=2 is 8 special have only 1 of them that rate up
                    gearsJson.push(specialJson[2]); //ใช้ตำแหน่งอาเรย์ในการบอกเรนเจอร์พิเศษ จะได้ใช้pathเดียวกันเลย ไม่ต้องก็อปวางหลายๆอัน
